...
{
 var Selected_Hazard = document.getElementById("Hazard_Type").value;
 var Selected_HS = "";
 var Selected_Harm = "";
 window.open("RiskFMEA_Harm.php?Hazard="+Selected_Hazard+"&HS="+Selected_HS+"&Harm="+Selected_Harm, "_self");
}
	
function Select_HS()
{
 var Selected_HS = document.getElementById("HS_Type").value;
 var Selected_Hazard = "";
 var Selected_Harm = "";	
 window.open("RiskFMEA_Harm.php?Hazard="+Selected_Hazard+"&HS="+Selected_HS+"&Harm="+Selected_Harm, "_self");
}
...
{
 var Selected_Harm = document.getElementById("Harm_Type").value;
 var Selected_Hazard = "";
 var Selected_HS = "";	
 window.open("RiskFMEA_Harm.php?Hazard="+Selected_Hazard+"&HS="+Selected_HS+"&Harm="+Selected_Harm, "_self");
}
