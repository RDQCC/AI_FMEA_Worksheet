...
{
 var Selected_Project = document.getElementById("Project_ID").value;				
 window.open("RiskFMEA_RMPWord.php?Project="+Selected_Project, "_self"); 
}		
...
if (isset($_POST['Feedback_Submit']))		
	...
	echo "<script>window.location='RiskFMEA_RMPWord.php?Project=$Project_ID'</script>";
	}
...
<td class="NewUser_Table2_InputTitle" style="text-indent:0.7em; font-size:14px; ">Create RMP Report</td>
