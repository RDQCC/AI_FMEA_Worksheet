...
$dataArray = getWordDocumentData($Project_ID);
 ...
 * @return string
 */
function getWordDocumentData($Project_ID = 0) {
    $dataArray = [];

    $dataArray['App_cat'] = 'TBD';
    $dataArray['doc_desc'] = 'Risk Management Plan for Project ' . $Project_ID;
    $dataArray['long_desc'] = 'N/A';
    $dataArray['Prepared_by'] = 'TBD';
    $dataArray['Date'] = '9/8/2017';
    $dataArray['valid_from'] = '';
    $dataArray['eco'] = 'N/A';
    $dataArray['RMP_no'] = '1049';
    $dataArray['RMP_version'] = 'A';
    ...
    $dataArray['footerfirstpage'] = "<p style='text-align:center'>Form 9198035- 042 Ver B. Complete per SOP105-03.</p>";
    $dataArray['footerallnextpages'] = "<p style='text-align:center,color:#000000'><strong>RMP</strong><span style='color:red'>1049</span> Version: <strong>B</strong>			<strong>RDQCC Confidential</strong></p><p>This document is electronically controlled. Printed copies are considered uncontrolled past the print date.</p>";

    $dataArray['alldata'][0] = array("title" => "Scope", "content" => "This risk management plan applies to management product safety risk for the project " . $Project_ID . ", throughout the product lifecycle, at RDQCC facilities, in accordance with SOP104-08.");
    $dataArray['alldata'][1] = array("title" => "Purpose", "content" => "The purpose of this risk management plan is to establish the risk management team and define the risk management and design qualification activities that will be conducted during the design and commercialization.");
    $dataArray['alldata'][2] = array("title" => "Relevant Documents", "content" => "The purpose of this risk management plan is to establish the risk management team and define the risk management and design qualification activities that will be conducted during the design and commercialization.");
    ...
    $dataArray['alldata'][7]['childs'][0]["para"][3] = array("content" => "Get guidance from RMP1111");
    ...
    $dataArray['alldata'][11]["para"][1] = array("content" => "The risk management plan shall be reviewed before the risk management report is completed and the risk management engineer is responsible for conducting the risk management plan review before the RMR is completed.");
    $dataArray['alldata'][11]["para"][2] = array("content" => "The plan for risk management reviews is documented in the table below.  The risk management reviews are documented in the corresponding RMF.");
    $dataArray['alldata'][11]["datatable"][0] = array("RMF Component Reviewed" => "RMF", "Review Frequency" => "Annual", "Comments" => "None");
    $dataArray['alldata'][11]["datatable"][1] = array("RMF Component Reviewed" => "RMP", "Review Frequency" => "Whenever the production plan or risk management plan changes.", "Comments" => "None");
    ...
    $dataArray['alldata'][12]["para"][0] = array("content" => "The qualification activities shall be performed according to the product validation plan(s) and the qualification results shall be documented in the product validation report(s):");
    ...
    $dataArray['alldata'][17]["datatable"][0] = array("VERSION" => "B", "DESCRIPTION OF CHANGE" => "New RMP template (9198035-042)");
...
function outputFMEADataToWord($dataArray, $RiskFMEAData) {
    ...
    $table->addCell(5000, $cellColSpan)->addText("RMP {$dataArray['RMP_no']} Version {$dataArray['RMP_version']}", $cellstylebold, $cellaftercenter);
