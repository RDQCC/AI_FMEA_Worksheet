...
if (isset($_POST['Feedback_Submit']))		
	...
	echo "<script>window.location='RiskFMEA_CAPA.php?Project=$Project_ID'</script>";
	}
...
<td class="NewUser_Table2_InputTitle" style="text-indent:0.7em; font-size:14px; ">Create CAPA Trigger Report</td>
