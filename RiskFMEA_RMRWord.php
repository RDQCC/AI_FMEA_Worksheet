...
function getWordDocumentData($Project_ID = 0) {
    ...
    $dataArray['doc_desc'] = 'Risk Management Report for Project ' . $Project_ID;
    $dataArray['long_desc'] = 'N/A';
    $dataArray['Prepared_by'] = 'TBD';
    $dataArray['Date'] = '9/8/2017';
    $dataArray['valid_from'] = '';
    $dataArray['eco'] = 'N/A';
    $dataArray['RMR_no'] = '1050';
    $dataArray['RMR_version'] = 'A';
    ...
    $dataArray['footerallnextpages'] = "<p style='text-align:center,color:#000000'><strong>RMR</strong><span style='color:red'>1049</span> Version: <strong>B</strong>			<strong>RDQCC Confidential</strong></p><p>This document is electronically controlled. Printed copies are considered uncontrolled past the print date.</p>";

    $dataArray['alldata'][0] = array("title" => "Scope", "content" => "This risk management report applies to management product safety risk for the project " . $Project_ID . ", throughout the product lifecycle, at RDQCC facilities, in accordance with SOP104-08.");
    $dataArray['alldata'][1] = array("title" => "Purpose", "content" => "The purpose of this risk management report is to summarize the risk management activities that will be conducted during the design, development, and commercialization.");
    $dataArray['alldata'][2] = array("title" => "Relevant Documents", "content" => "The relvant documents are associated with the risk management report during the design, development, and commercialization.");
    ...
    $dataArray['alldata'][7]['childs'][0]["para"][3] = array("content" => "Get guidance from RMR1111");
    ...
    $dataArray['alldata'][11]["para"][1] = array("content" => "The risk management report shall be reviewed before the risk management report is completed and the risk management engineer is responsible for conducting the risk management report review before the RMR is completed.");
    ...
    $dataArray['alldata'][17]["datatable"][0] = array("VERSION" => "B", "DESCRIPTION OF CHANGE" => "New RMR template (9198036-043)");
...
function outputFMEADataToWord($dataArray, $RiskFMEAData) {
    ...
    $table->addCell(5000, $cellColSpan)->addText("RMR {$dataArray['RMR_no']} Version {$dataArray['RMR_version']}", $cellstylebold, $cellaftercenter);
