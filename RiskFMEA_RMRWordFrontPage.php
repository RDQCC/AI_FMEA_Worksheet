...
function Select_a_Project()
{
 ...
 window.open("RiskFMEA_RMRWord.php?Project="+Selected_Project, "_self"); 
}		
...
if (isset($_POST['Feedback_Submit']))		
	...
	echo "<script>window.location='RiskFMEA_RMRWord.php?Project=$Project_ID'</script>";
	}
...
<td class="NewUser_Table2_InputTitle" style="text-indent:0.7em; font-size:14px; ">Create RMR Report</td>
